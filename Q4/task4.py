...
class BankAccount:
    ...
    Class Attributes:
        ...
        banned_accounts (set): Set of banned account numbers.
    ...
    def set_next_account_number(cls, next_account_number: int) -> None:
        ...
        # Assert that the next account number is set correctly.
    ...
    def unban_all(cls) -> None:
        """
        Remove all account bans by clearing the set of banned account numbers.
        """

        # Clear the banned_accounts set.
        cls.banned_accounts.clear()

        # Assert that the banned_accounts set is empty.
